...
for i in range(51): print(i)  # count upto 50
print()
for i in range(50, -1, -1): print(i)  # count down from 50 uptill 0
print()
for i in range(30, 51): print(i)  # count from 30 to 50
print()
for i in range(50, 9, -2): print(i)  # count from 50 to 10
print()
for i in range(100, 201, 5): print(i)  # Coun up from 100 to 200 